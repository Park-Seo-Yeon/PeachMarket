...
def test_gmm(opt, test_loader, model, board):
    ...
    for step, inputs in enumerate(test_loader.data_loader):
        ...
        save_images(warped_cloth, im_names, "C:/Users/suhyun/VirtualTryOn/cp-vton-plus-master/data/warp-cloth")
        save_images(warped_mask * 2 - 1, im_names, "C:/Users/suhyun/VirtualTryOn/cp-vton-plus-master/data/warp-mask")
...
def test_tom(opt, test_loader, model, board):
    ...
    for step, inputs in enumerate(test_loader.data_loader):
        ...
        ############################################################################
        #셀카에서도 이런 식으로 얼굴 추출, 크롭, 배경제거해서 모델 사진에 붙여넣기?
